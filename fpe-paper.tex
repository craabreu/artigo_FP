...
\begin{document}
	...
	\begin{figure}
		\includegraphics[width=0.9\columnwidth]{phenanthrene}
		\caption{Level of coarse-graining and geometry chosen for the phenanthrene molecule.}
		\label{fig:fen5}
	\end{figure}
	
	\begin{figure}
		\includegraphics[width=0.9\columnwidth]{eos}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.9\columnwidth]{optimized_cdf}
	...
	\begin{figure}
		\centering
		\includegraphics[width=1.0\linewidth]{hexart}
	...
	\begin{figure}
		\centering
		\includegraphics[width=1.0\linewidth]{octart}
	...
	\begin{figure}
		\centering
		\includegraphics[width=1.0\linewidth]{tolart}
	...
	\begin{figure}
		\centering
		\includegraphics[width=1.0\linewidth]{waterart}
