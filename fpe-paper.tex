...
\begin{document}
	...
	At first, we set to zero the binary interaction parameters of all aqueous mixtures, but preliminary results for hydration free energies exhibited a high deviation from experimental data \cite{P29900000291, doi:10.1021/ct050097l}.
	...
	\begin{table*}
			...
			\begin{tabular}{cccc}
				\hline\hline
				       Solute        & $\Delta G_{solv}^{exp}$ & \vtop{\hbox{\strut $\Delta G_{solv}^{Mie}$}\hbox{\strut $k_{ij} \neq 0$}} & \vtop{\hbox{\strut Absolute}\hbox{\strut Deviation}} \\ \hline
				      propane        &     $2.00 \pm 0.20$     &                              $2.01 \pm 0.01$                              &                         0.01                         \\
				      benzene        &    $-0.86 \pm 0.20$     &                             $-1.12 \pm 0.01$                              &                         0.26                         \\
				      toluene        &    $-0.83 \pm 0.20$     &                             $-0.84 \pm 0.01$                              &                         0.01                         \\
				phenanthrene (set 1) &    $-3.88 \pm 0.60$     &                             $-3.47 \pm 0.02$                              &                         0.41                         \\
				phenanthrene (set 2) &    $-3.88 \pm 0.60$     &                             $-5.12 \pm 0.02$                              &                         1.24                         \\ \hline\hline
			\end{tabular}
	\end{table*}
    ...
    This is so because the associative term of the SAFT-VR Mie EoS \cite{lafitte2013} has not been incorporated into the force field.
