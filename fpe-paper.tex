...
\begin{document}
	...
	\begin{table*}
		\centering
		\caption{\hl{Hydration free energies (kcal/mol) calculated with the SAFT-$\gamma$ Mie force field and binary interaction parameters.}}
		\label{tbl:solv2}
		\begin{tabular}{cccccc}
			\hline\hline
